...
const AdminPTRequests = () => {
  ...
  useEffect(() => {
    loadRequests();
    // Recarregar a cada 5 segundos para ver novos pedidos
  ...
  const handleApprove = async (requestId, clientName, newPT) => {
    ...
    try {
      ...
      const message = newPT === 'Nenhum PT'
        ? `Aprovado! ${clientName} agora não tem PT`
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mb-4">
                      <div className="space-y-2">
                        ...
                        <div>
                          <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase">
                            {req.toPT === 'Nenhum PT' ? 'PT Solicitado' : 'Novo PT Solicitado'}
                          </p>
...
export default AdminPTRequests;